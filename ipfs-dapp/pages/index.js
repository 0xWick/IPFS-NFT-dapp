...
export default function Home() {
  ...
  // tokeIdsMinted keeps track of the number of tokenIds that have been minted
  ...
  const publicMint = async () => {
    try {
      ...
      // call the mint from the contract to mint the Azuki
      const tx = await nftContract.mint({
        // value signifies the cost of one Azuki which is "0.01" eth.
      ...
      setLoading(false);
      window.alert("You successfully minted an Azuki!")
